...
const coverageDetails = [
  {
    label: "Products",
    value: "Savings, checking, MMAs, CDs",
  },
  {
    label: "Fees",
    value: "Low monthly fees",
  },
  {
    label: "Access",
    value: "Digital‑first",
        ...
        <CardContent className="p-0 space-y-6">
          <header className="flex items-center gap-2">
            <h2 className="[font-family:'Work_Sans',Helvetica] font-bold text-black text-2xl leading-8">
              <span className="underline">Quontic Bank</span>
            </h2>
              ...
              <div className="w-full bg-white rounded-[0px_0px_16px_16px] border border-t-0 border-[#E5E7EB] p-4 flex items-center justify-center">
                <div className="flex items-center gap-3">
                  <div className="w-[52px] h-[52px] rounded-full border-[3px] border-[#F3C060] flex items-center justify-center">
                    <span className="text-[#007AC8] text-xl font-bold" style={{ fontFamily: 'Work Sans' }}>4.9</span>
                  </div>
              ...
              <>
                ...
                <div className="flex flex-col gap-[18px]">
                  <p className="text-base leading-[26px] sm:text-lg sm:leading-[29.12px]" style={{ 
                    ...
                    Quontic Bank offers a flexible product lineup with competitive savings and checking options. Its digital-first experience keeps account management straightforward.
                  </p>
                  ...
                  {isExpanded && (
                    <>
                      <p style={{ 
                        ...
                        Our rating reflects Quontic's account flexibility, product breadth, and overall digital experience compared with other online banks.
                      </p>
