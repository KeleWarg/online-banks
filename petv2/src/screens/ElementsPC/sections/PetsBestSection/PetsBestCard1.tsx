...
const coverageDetails = [
  {
    label: "Savings APY",
    value: "Competitive high‑yield rate",
  },
  {
    label: "Monthly fees",
    value: "$0",
...
const prosConsData = [
  {
    pro: "Strong savings-focused APY with simple account structure",
    con: "Savings-only (no checking account)"
  },
  {
    pro: "No monthly maintenance fees",
    con: "ATM access depends on transfers to external accounts"
  },
  {
    pro: "Easy online account opening",
    con: "Limited product breadth compared to full-service banks"
  },
  {
    pro: "Reputable brand with straightforward terms",
    con: null
  }
];
        ...
        <CardContent className="p-0 space-y-6">
          <header className="flex items-center gap-2">
            <h2 className="[font-family:'Work_Sans',Helvetica] font-bold text-black text-2xl leading-8">
              <span className="underline">American Express®</span>
            </h2>
              ...
              <div className="w-full bg-white rounded-[0px_0px_16px_16px] border border-t-0 border-[#E5E7EB] p-4 flex items-center justify-center">
                <div className="flex items-center gap-3">
                  <div className="w-[52px] h-[52px] rounded-full border-[3px] border-[#F3C060] flex items-center justify-center">
                    <span className="text-[#007AC8] text-xl font-bold" style={{ fontFamily: 'Work Sans' }}>5.0</span>
                  </div>
            ...
            {activeTab === "pros-cons" && (
              <>
                <h4 className="[font-family:'Work_Sans',Helvetica] font-semibold text-black text-xl tracking-[-0.33px] leading-8">
                  Pros & Cons of American Express HYSA
                </h4>
              ...
              <>
                ...
                <div className="flex flex-col gap-[18px]">
                  <p className="text-base leading-[26px] sm:text-lg sm:leading-[29.12px]" style={{ 
                    ...
                    The American Express High Yield Savings Account stands out for its savings-focused rate and straightforward fee structure. It’s designed for savers who want a clean, no‑fee option.
                  </p>
                  ...
                  {isExpanded && (
                    <>
                      <p className="text-base leading-[26px] sm:text-lg sm:leading-[29.12px]" style={{ 
                        ...
                        Account terms are straightforward, making it easy to compare against other high‑yield savings options.
                      </p>
